...
path_data_energy <-"~/data/energy/oecd/"
...
dt.energy.prices<-fread(paste0(path_data_energy,"klems_energy_fin_to_george.csv"))
...
xwalk.nace.klems.oecd<-fread(paste0(path_data_energy, "xwalk.nace.klems.oecd.csv"))
